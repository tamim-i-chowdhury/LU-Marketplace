...
import tamimImg from "../assets/team-picture/tamim.jpeg";
import sagorImg from "../assets/team-picture/sagor.jpeg";
import tahmidImg from "../assets/team-picture/tahmid.jpeg";
        ...
        <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-96 xl:w-96 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold">Shoshangka Shekhor Roy</p>
          ...
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-96 dark:bg-gray-100 dark:text-gray-800">
            ...
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold">Asir Ahnaf Tahmid</p>
              <p>Frontend Developer</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <Link
          ...
          <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-96 xl:w-96 dark:bg-gray-100 dark:text-gray-800">
            ...
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold">Tamim Iqbal Chowdhury</p>
              <p>Full Stack Developer</p>
            </div>
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <Link
                to="tamim.c183@gmail.com"
                title="Email"
                className="dark:text-gray-900 hover:dark:text-violet-400"
              >
                <svg
              ...
              <Link
                to="https://www.linkedin.com/in/tamim-i-chowdhury/"
                title="LinkedIn"
                className="dark:text-gray-900 hover:dark:text-violet-400"
              >
                <svg
              ...
              <Link
                to="https://github.com/tamim-i-chowdhury"
                title="GitHub"
                className="dark:text-gray-900 hover:dark:text-violet-400"
              >
                <svg
